              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="produto1.php">Produto 1</a></li>
                    <li><a class="dropdown-item" href="produto2.php">Produto 2</a></li>
                    <li><a class="dropdown-item" href="produto3.php">Produto 3</a></li>
                  </ul>
                </li>
                <li class="nav-item">
